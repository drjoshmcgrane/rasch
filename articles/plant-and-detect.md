...
| Person-subset dimensionality test | 400 persons; 30 dichotomous or 20 four-category items; B = 99 | the uncalibrated residual-derived split flagged 15% and 41% of null datasets. Bootstrap rejection was 5% and 9% (MCSE 2.2 and 2.9 points). The descriptive fixed-split binomial rule flagged none in these designs; it is not a calibrated test under unequal targeting. Power was 100% for the planted second dimension (100 datasets per condition; no refusals) |
| Fixed-subset targeting | 300 persons; ten dichotomous items at -1.5 logits and ten at +1.5; B = 39 | the uncalibrated binomial rule flagged 18% of 100 unidimensional datasets (MCSE 3.8 points), versus 3% with bootstrap calibration (MCSE 1.7 points). All 3,900 refits completed. This is a targeted check of unequal targeting, not validation across all splits. |
