...
A list of class `"rmt_ctt"`: the per-item `table` (`item`, `n`,
...
#>  item   n facility item_total item_rest    di alpha_drop
#>    I1 400    0.848      0.370     0.169 0.298      0.519
#>    I2 400    0.787      0.443     0.221 0.373      0.504
#>    I3 400    0.672      0.479     0.226 0.484      0.504
#>    I4 400    0.575      0.526     0.267 0.589      0.488
#>    I5 400    0.432      0.579     0.333 0.663      0.460
#>    I6 400    0.338      0.495     0.243 0.497      0.497
#>    I7 400    0.250      0.533     0.313 0.527      0.472
#>    I8 400    0.175      0.407     0.198 0.316      0.511
```
